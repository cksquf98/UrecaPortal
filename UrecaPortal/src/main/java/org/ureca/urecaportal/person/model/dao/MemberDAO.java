...
public interface MemberDAO {
    ...
    @Update("update members set password=#{password}, name=#{name}, phone=#{phone}, location=#{location}, seat=#{seat} where id=#{id}")
    ...
    @Select("select member_idx, id, name, phone, seat, location from members where seat is not null order by name")
    ...
    @Select("select member_idx, id, name, seat from members where seat is not null order by rand()")
